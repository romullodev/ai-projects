...
def search_10k(data):
  """
  Useful for searching information from the most recent Form 10-K for a
  certain stock. Enter a string as input as follows:
  
  `AAPL | what was last year's revenue`, where
  
  `AAPL`: is the stock ticker 
  `what was last year's revenue`: what is your question about this 
  """
  # """
